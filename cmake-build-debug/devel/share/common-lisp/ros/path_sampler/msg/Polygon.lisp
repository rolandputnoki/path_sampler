...
(cl:defclass <Polygon> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector path_sampler-msg:Point)
   :initform (cl:make-array 0 :element-type 'path_sampler-msg:Point :initial-element (cl:make-instance 'path_sampler-msg:Point))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Polygon>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Polygon)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_sampler-msg:<Polygon> is deprecated: use path_sampler-msg:Polygon instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_sampler-msg:points-val is deprecated.  Use path_sampler-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Polygon>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'path_sampler-msg:Point))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Polygon>)))
  ...
  (cl:format cl:nil "Point[] points~%~%~%================================================================================~%MSG: path_sampler/Point~%float64 x~%float64 y~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Polygon)))
  "Returns full string definition for message of type 'Polygon"
  (cl:format cl:nil "Point[] points~%~%~%================================================================================~%MSG: path_sampler/Point~%float64 x~%float64 y~%~%~%~%"))
